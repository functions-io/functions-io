...
var FunctionsFactory = function(){
    ...
    this.invokeMessage = function(messageRequest, callBack){
        this.invoke(messageRequest.stage, messageRequest.method, messageRequest.version, messageRequest.params, messageRequest.header, function(errInvoke, resultInvoke, functionManager){
            var messageResponse = {};
            ...
            if (this.isGenerateStatistics === true){
                (function(){
                    try {
                        ...
                        message = self.inputValidate.parse(functionManager.name, message, functionManager.module.input); //validate and parse
