...
var Server = function(config){
    ...
    if ((this.server.config.cors === undefined) || (this.server.config.cors === null)){
        ...
        this.server.config.cors.enable = true;
    ...
    if ((this.server.config.html === undefined) || (this.server.config.html === null)){
        ...
        this.server.config.html.enable = true;
        this.server.config.html.port = "8081";
    }
    
    this.start = function(callBack){
        if ((this.server.config.html) && (this.server.config.html.enable)){
            this.serverHTML = new ServerHTML(this.server.config.html);
