...
var FileScan = function(functionsFactory, basePATH, autoScan, disableLoadUnitTest){
    ...
    if ((disableLoadUnitTest === undefined) || (disableLoadUnitTest === null)){
        disableLoadUnitTest = false;
    }
