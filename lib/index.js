...
module.exports.loadLocalObjectInCache = module.exports.invokeFactory.moduleFactory.moduleCache.loadLocalObjectInCache;
    ...
    for (var i = 0; i < listKey.length; i++){
        ...
        if (gateway.enabled){
            try {
                ...
                core.log.error("functions-io", "loadGatewayDelcaredInConfig", {key:key, message:errTry.message});
            }
        }
    }
};
    ...
    for (var i = 0; i < listKey.length; i++){
        ...
        if (dataSourceDriver.enabled){
            try {
                ...
                core.log.error("functions-io", "loadDataSourceDriverDelcaredInConfig", {key:key, message:errTry.message});
            }
        }
    }
};
